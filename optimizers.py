...
class Optimizer:
    def __init__(self, function, initialPoint, gradient=None, jacobi=None, hesse=None,
                 interval=None, epsilon=1e-7, function_array=None, basicFunct=None, metaclass=ABCMeta):
...
def getOptimizers(function, initialPoint, gradient, jacobi, hesse, interval, function_array, fun):
    return [optimizer(function, initialPoint, gradient=gradient, jacobi=jacobi, hesse=hesse,
                      interval=interval, function_array=function_array, basicFunct=fun)
            for optimizer in [
